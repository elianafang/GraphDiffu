...
def parse_args():
    ...
    # General arguments
    parser.add_argument('-d', '--dataset', default='humaneva', type=str,
                        metavar='NAME', help='target dataset')  # h36m or humaneva
    parser.add_argument('-k', '--keypoints', default='gt',
    ...
    parser.add_argument('--save_lmin', default=41.10, type=int, metavar='N')
    parser.add_argument('--save_lmax', default=41.25, type=int, metavar='N')
    parser.add_argument('--save_lmin_gt', default=21.20, type=int, metavar='N')
    parser.add_argument('--save_lmax_gt', default=21.35, type=int, metavar='N')
    parser.add_argument('--save_emin', default=70, type=int, metavar='N')
    ...
    parser.add_argument('-c', '--checkpoint', default='checkpoint/model_humaneva_gt', type=str, metavar='PATH',
    ...
    # Model arguments
    parser.add_argument('-s', '--stride', default=243, type=int,
                        metavar='N', help='chunk size to use during training')
    parser.add_argument('-e', '--epochs', default=100, type=int,
                        metavar='N', help='number of training epochs')
    parser.add_argument('-e_gt', '--epochs_gt', default=120, type=int,
                        metavar='N', help='number of training epochs')
    ...
    parser.add_argument('-cs', default=512, type=int,
                        help='channel size of model, only for trasformer')
