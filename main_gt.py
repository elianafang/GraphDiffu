...
if not args.evaluate:
    ...
    while epoch < args.epochs_gt:
        ...
        if losses_3d_valid[-1][0] * 1000 < min_loss:
            ...
            if epoch >= args.save_emin and args.save_lmin_gt <= losses_3d_valid[-1][0] * 1000 <= args.save_lmax_gt and flag_best_20_10 == False:
